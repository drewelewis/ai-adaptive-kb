...
class IntelligentIntentClassifier:
    ...
    instead of manual phrase enumeration
    """
...
def test_intelligent_classifier():
    """Test the intelligent classifier with various phrases"""
    ...
    print("🧠 INTELLIGENT INTENT CLASSIFIER TEST")
    print("=" * 60)
    
    for phrase in test_phrases:
        intent, confidence = classifier.classify_intent(phrase)
        print(f"'{phrase[:40]:<40}' → {intent:<20} ({confidence:.1f}%)")
    
    print("\n" + "=" * 60)
    print("✅ Natural language patterns handle diverse phrasings automatically!")
    print("✅ No need to manually add every possible phrase variation!")
